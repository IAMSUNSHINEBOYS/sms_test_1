...
public class HttpUtils {
    ...
    private static HttpClient sslClient() {
        try {
            ...
            // 创建Registry
            RequestConfig requestConfig = RequestConfig.custom().setConnectTimeout(30000).setSocketTimeout(30000) .setCookieSpec(CookieSpecs.STANDARD_STRICT)
    ...
    public static JSONObject parseJson(HttpResponse httpResponse) throws IOException {
        return JSONObject.fromObject(parseString(httpResponse));
